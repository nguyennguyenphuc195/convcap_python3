...
from convcapCustom import Convcap
from vggfeats import Vgg16Feats
from resnet_feats import resnetFeats
...
def train(data_root="./data/coco/", epochs=30, batchsize=20, ncap_per_img=5, num_layers=3,\
    ...
    if ImageCNN == resnetFeats:
        nimgfeats = 2048
    elif ImageCNN == Vgg16Feats:
        nimgfeats = 4096
        
    #convcap model
    convcap_model = Convcap(train_ds.vocab_size, num_layers, is_attention, reduce_dim=reduce_dim, nimgfeats = nimgfeats)
